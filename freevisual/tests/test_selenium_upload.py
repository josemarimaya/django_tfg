...
class TestSignUpAndUploadImage(StaticLiveServerTestCase):
    def setUp(self):
        ...
        # Urls que necesitaremos en el testing
    ...
    def test_create_user_and_upload_image(self):
        ...
        # Hacemos submit buscando el botón por su texto
        self.driver.find_element(By.XPATH, "//button[contains(text(), 'Save')]").click()

        # Verificamos que el usuario ha sido creado y autenticado
        ...
        # Obtenemos el path de la imagen de prueba
        image_path = os.path.join(os.getcwd(), 'freevisual/tests', 'testing.jpg')

        # Rellenamos el formulario de subida de imagen
        ...
        # Hacemos submit para subir la imagen
        self.driver.find_element(By.XPATH, "//button[contains(text(), 'Sube tu imagen')]").click()

        # Verificamos si la imagen ha sido subida con éxito (redirige al 'main')
